...
const AboutMeSection=()=> {
  return (
    <div
        className="relative"
        style={{
          backgroundImage: `url(https://wallpapercave.com/wp/wp8719460.jpg)`,
        }}
      >
          ...
          >
            <div class="p-4 md:p-12 text-center lg:text-left">
              <div
                ...
                style={{
                  backgroundImage: `url(https://images.unsplash.com/photo-1682685796014-2f342188a635?auto=format&fit=crop&q=80&w=3540&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)`,
                }}
              ></div>
