...
import HU from "../../Assets/SVGs/flag-hu.svg";
import DE from "../../Assets/SVGs/flag-de.svg";
import EN from "../../Assets/SVGs/flag-us.svg";
  ...
  return (
    ...
    >
      <div className="w-full flex flex-col items-center">
        <h1
          data-aos="fade-up"
          class="text-5xl lg:text-7xl  lg:pt-0 mt-[50px] lg:mt-[105px] mb-2 text-white font-custom3"
        >
          About Me
        </h1>
        <h2
          data-aos="fade-up"
          class="text-lg text-gray-300 mb-[0px] lg:mb-[60px]"
        >
