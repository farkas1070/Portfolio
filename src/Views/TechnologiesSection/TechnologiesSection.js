...
const TechnologiesSection = () => {
  const initialCards = [
    ...
    { imgSource: DotnetSVG, name: ".NET", expLevel: "Intermediate" },
  ...
  const allCards = [
    ...
    { imgSource: MongodbSVG, name: "MongoDB", expLevel: "Intermediate" },
    { imgSource: BootstrapSVG, name: "Bootstrap", expLevel: "Experienced" },
    { imgSource: MuiSVG, name: "Material UI", expLevel: "Intermediate" },
    { imgSource: PythonSVG, name: "Python", expLevel: "Experienced" },
    { imgSource: gitSVG, name: "GIT", expLevel: "Experienced" },
